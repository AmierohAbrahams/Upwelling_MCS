...
Using the generalised linear hypotheses - Look at the difference in count of upwelling within the different datasets (in situ, CMC, OISST). Look at the difference in duration of upwelling between the thre datasets.

To determine wether or not the same upwlling patterns are present at different distances from the coastline

Offshore Upwelling:
Which pixels showed the highest upwelling counts
Which site showed the most intense upwelling 

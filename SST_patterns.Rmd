...
upwelling <- UI_angle %>%
  ...
  mutate(clim = purrr::map(data, ts2clm, climatologyPeriod = c("2010-06-23", "2014-08-15")), # creating a column of climatologies. Column will be named clim
...
ts2clm_custom <- function(df){
  ...
  res <- ts2clm(df, pctile = 25, climatologyPeriod = c("2010-06-23", "2014-08-15"))
  return(res)
}
# 

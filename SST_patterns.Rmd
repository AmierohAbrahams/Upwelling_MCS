...
## Using series of general linear hypotheses (Hothorn et al., 2008) to look for differences in upwelling signal metrics between datasets and between sites
# Is there a significant difference in the count between the datasets at a particular site

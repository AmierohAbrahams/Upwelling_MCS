...
Sites located within the OISST datasets shows no difference in duration of the events at different distances for each of the sites from the coastline. However, there is a difference in the mean intensity of events between sites (F=5.74, SS=5.2, p<0.0006). It is also evident that there is a significant difference in the mean intensity of the event at different distances from the coastline (F=260.17, SS=78.6, p<0.001), as well as differences in the duration in events (F=51.39, SS=15.53, p<0.001) and between sites . Similarly, the second dataset, the CMC dataset, results obtained from a  three-way ANOVA showed that there  was no a significant difference in the duration of events at different distances from the coastline for each of the sites (F=1.20, SS=0.41, p>0.05). However, there is a difference in the mean intensity of events at diferent distances (F=471.63, SS=162.0, p<0.05), as well as a signifcant difference in the duration of events (F=38.36, SS=13.2, p<0.006), and between sites (F=17.64, SS=18.2, p<0.002). It is also seen that there is no significant difference between the duration of upwelling between the various sites (F=0.22 SS=0.2, p<0.87). When looking at the in situ collected dataset, data collected at the coastline, we find no difference in the duration of events at the different sites (F=2.05, SS=1.84, p>0.11), however, we see a difference in the mean intensity of events at the different sites (F=2.05, SS=0.61, p>0.44).

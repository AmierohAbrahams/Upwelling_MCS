...
The regression slope shows the slope of the trend for each of the datasets used within this study. When looking at the OISST dataset, it is eveident that there is no contstant trend among sites. It is evident however that the strongest trends exist at 10km from the coastline, with the weakest trends occuring at a distance of 30 – 40km from the coastline. In the CMC dataset events occuring at a distance of 10km from the coastline shows the strongest trend compared to trends observed at a distance of 50km from the coasltine. In this dataset we see that at a distance of 10km, Lamberts Bay shows that every decade upwelling lasts for approximatly 3days longer. Similarly, Port Nolloth shows that upwelling lasts for approximately 2 days longer. Both Saldanha Bay and Sea Point shows a trend of upwelling lasting for approximately 3 days more. When looking at the in situ collected temperatur data the trend represents an increase of 1 additional day per decade for each of the sites expect Saldanha Bay. Here Saldanha Bay represent a trend value of 0.37 which largely varies with the trend values obtained from the OISST and CMC dataset.

...
site_map <- ggplot(data = south_africa_coast, aes(x = lon, y = lat)) + 
  #geom_raster(data = OISST, aes(x = lon, y = lat, fill = temp)) +
  ...
  coord_equal(xlim = c(15.5, 20), ylim = c(-35,-27), expand = 0) +
  ...
  #            size = 4, angle = 0, colour = "black") +
    ...
    # annotate("text", label = "Benguela", x = 15, y = -30,
  ...
  coord_fixed(ratio = 1, xlim = c(15, 21.5), ylim = c(-35,-27),
                expand = TRUE) +

...
# 
# wind_2 <- read.delim("Documents/Data/Wind_data/wind_data.txt(SAWS)/wind2/wind2.txt", na.strings = "",
#                      col.names = c("station_number", "station_name", "date", "hour", "sub" ,"speed", "dir"))
# 
...
# selected_sites <- c("Port Nolloth", "Lamberts Bay", "Sea Point", "Saldanha Bay") #Removed Hout Bay as this is not one of my sites.
# 
...
# 
# # Errors in the wind data for Port Nolloth - Recieved the correct wind data with no missing hours
# 
...
#                                                            template = 'geographics')),2)) #, # Direction using the circular function
